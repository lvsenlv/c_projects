...
#define STR_BACK                                ((LAN_EN == g_LanguageFlag) ? STR_EN_BACK                         : STR_CH_BACK                          )
#define STR_BEYOND_RANGE_OF_DISP                ((LAN_EN == g_LanguageFlag) ? STR_EN_BEYOND_RANGE_OF_DISP         : STR_CH_BEYOND_RANGE_OF_DISP          )
#define STR_CONSOLE_END_LINE                    ((LAN_EN == g_LanguageFlag) ? STR_EN_CONSOLE_END_LINE             : STR_CH_CONSOLE_END_LINE              )
#define STR_CONSOLE_LABEL                       ((LAN_EN == g_LanguageFlag) ? STR_EN_CONSOLE_LABEL                : STR_CH_CONSOLE_LABEL                 )
#define STR_CONTINUE                            ((LAN_EN == g_LanguageFlag) ? STR_EN_CONTINUE                     : STR_CH_CONTINUE                      )
#define STR_DISP_ERR_INFO                       ((LAN_EN == g_LanguageFlag) ? STR_EN_DISP_ERR_INFO                : STR_CH_DISP_ERR_INFO                 )
#define STR_ESC_EXIT                            ((LAN_EN == g_LanguageFlag) ? STR_EN_ESC_EXIT                     : STR_CH_ESC_EXIT                      )
#define STR_EXIT_PROJECT                        ((LAN_EN == g_LanguageFlag) ? STR_EN_EXIT_PROJECT                 : STR_CH_EXIT_PROJECT                  )
#define STR_FILE_IS_NULL                        ((LAN_EN == g_LanguageFlag) ? STR_EN_FILE_IS_NULL                 : STR_CH_FILE_IS_NULL                  )
#define STR_FILE_LIST_IS_NULL                   ((LAN_EN == g_LanguageFlag) ? STR_EN_FILE_LIST_IS_NULL            : STR_CH_FILE_LIST_IS_NULL             )
#define STR_FILE_NOT_EXIST                      ((LAN_EN == g_LanguageFlag) ? STR_EN_FILE_NOT_EXIST               : STR_CH_FILE_NOT_EXIST                )
#define STR_FREE_MEMORY                         ((LAN_EN == g_LanguageFlag) ? STR_EN_FREE_MEMORY                  : STR_CH_FREE_MEMORY                   )
#define STR_GO_BACK                             ((LAN_EN == g_LanguageFlag) ? STR_EN_GO_BACK                      : STR_CH_GO_BACK                       )
#define STR_IF_CONTINUE                         ((LAN_EN == g_LanguageFlag) ? STR_EN_IF_CONTINUE                  : STR_CH_IF_CONTINUE                   )
#define STR_IN_ENCRYPTING                       ((LAN_EN == g_LanguageFlag) ? STR_EN_IN_ENCRYPTING                : STR_CH_IN_ENCRYPTING                 )
#define STR_IN_DECRYPTING                       ((LAN_EN == g_LanguageFlag) ? STR_EN_IN_DECRYPTING                : STR_CH_IN_DECRYPTING                 )
#define STR_INPUT                               ((LAN_EN == g_LanguageFlag) ? STR_EN_INPUT                        : STR_CH_INPUT                         )
#define STR_INPUT_FILE_NAME                     ((LAN_EN == g_LanguageFlag) ? STR_EN_INPUT_FILE_NAME              : STR_CH_INPUT_FILE_NAME               )
#define STR_INPUT_FILE_NAME_EG                  ((LAN_EN == g_LanguageFlag) ? STR_EN_INPUT_FILE_NAME_EG           : STR_CH_INPUT_FILE_NAME_EG            )
#define STR_INPUT_PASSWORD                      ((LAN_EN == g_LanguageFlag) ? STR_EN_INPUT_PASSWORD               : STR_CH_INPUT_PASSWORD                )
#define STR_INPUT_PASSWORD_CONFIRM              ((LAN_EN == g_LanguageFlag) ? STR_EN_INPUT_PASSWORD_CONFIRM       : STR_CH_INPUT_PASSWORD_CONFIRM        )
#define STR_INVALID_FUNC                        ((LAN_EN == g_LanguageFlag) ? STR_EN_INVALID_FUNC                 : STR_CH_INVALID_FUNC                  )
#define STR_INVALID_PARAMTER                    ((LAN_EN == g_LanguageFlag) ? STR_EN_INVALID_PARAMETER            : STR_CH_INVALID_PARAMETER             )
#define STR_LANGUAGE                            ((LAN_EN == g_LanguageFlag) ? STR_EN_LANGUAGE                     : STR_CH_LANGUAGE                      )
#define STR_LOG_IS_NULL                         ((LAN_EN == g_LanguageFlag) ? STR_EN_LOG_IS_NULL                  : STR_CH_LOG_IS_NULL                   )
#define STR_MACHINE_REQUIREMENT                 ((LAN_EN == g_LanguageFlag) ? STR_EN_MACHINE_REQUIREMENT          : STR_CH_MACHINE_REQUIREMENT           )
#define STR_MENU                                ((LAN_EN == g_LanguageFlag) ? STR_EN_MENU                         : STR_CH_MENU                          )
#define STR_NO                                  ((LAN_EN == g_LanguageFlag) ? STR_EN_NO                           : STR_CH_NO                            )
#define STR_NOT_A_FILE                          ((LAN_EN == g_LanguageFlag) ? STR_EN_NOT_A_FILE                   : STR_CH_NOT_A_FILE                    )
#define STR_NOT_NOT_SUPPORT_FUNCTION            ((LAN_EN == g_LanguageFlag) ? STR_EN_NOT_SUPPORT_FUNCTION         : STR_CH_NOT_SUPPORT_FUNCTION          )
#define STR_NULL                                ((LAN_EN == g_LanguageFlag) ? STR_EN_NULL                         : STR_CH_NULL                          )
#define STR_PASSWORD_NOT_MATCH                  ((LAN_EN == g_LanguageFlag) ? STR_EN_PASSWORD_NOT_MATCH           : STR_CH_PASSWORD_NOT_MATCH            )
#define STR_PASSWORD_NULL                       ((LAN_EN == g_LanguageFlag) ? STR_EN_PASSWORD_NULL                : STR_CH_PASSWORD_NULL                 )
#define STR_PASSWORD_TOO_SHORT                  ((LAN_EN == g_LanguageFlag) ? STR_EN_PASSWORD_TOO_SHORT           : STR_CH_PASSWORD_TOO_SHORT            )
#define STR_PERMISSION_DENIED                   ((LAN_EN == g_LanguageFlag) ? STR_EN_PERMISSION_DENIED            : STR_CH_PERMISSION_DENIED             )
#define STR_PRESS_ENTER_TO_GO_BACK              ((LAN_EN == g_LanguageFlag) ? STR_EN_PRESS_ENTER_TO_GO_BACK       : STR_CH_PRESS_ENTER_TO_GO_BACK        )
#define STR_PRO_REASON_NO_ENCRYPT_FILE          ((LAN_EN == g_LanguageFlag) ? STR_EN_PRO_REASON_NO_ENCRYPT_FILE   : STR_CH_PRO_REASON_NO_ENCRYPT_FILE    )
#define STR_PRO_REASON_NO_DECRYPT_FILE          ((LAN_EN == g_LanguageFlag) ? STR_EN_PRO_REASON_NO_DECRYPT_FILE   : STR_CH_PRO_REASON_NO_DECRYPT_FILE    )
#define STR_RATE                                ((LAN_EN == g_LanguageFlag) ? STR_EN_RATE                         : STR_CH_RATE                          )
#define STR_RETRY                               ((LAN_EN == g_LanguageFlag) ? STR_EN_RETRY                        : STR_CH_RETRY                         )
#define STR_SHOW_FILE_LABEL                     ((LAN_EN == g_LanguageFlag) ? STR_EN_SHOW_FILE_LABEL              : STR_CH_SHOW_FILE_LABEL               )
#define STR_SUCCESS                             ((LAN_EN == g_LanguageFlag) ? STR_EN_SUCCESS                      : STR_CH_SUCCESS                       )
#define STR_SUCCESS_COUNT                       ((LAN_EN == g_LanguageFlag) ? STR_EN_SUCCESS_COUNT                : STR_CH_SUCCESS_COUNT                 )
#define STR_TASK                                ((LAN_EN == g_LanguageFlag) ? STR_EN_TASK                         : STR_CH_TASK                          )
#define STR_TOTAL_FILE                          ((LAN_EN == g_LanguageFlag) ? STR_EN_TOTAL_FILE                   : STR_CH_TOTAL_FILE                    )
#define STR_THREAD_NUM                          ((LAN_EN == g_LanguageFlag) ? STR_EN_THREAD_NUM                   : STR_CH_THREAD_NUM                    )
#define STR_VIEW_LOG                            ((LAN_EN == g_LanguageFlag) ? STR_EN_VIEW_LOG                     : STR_CH_VIEW_LOG                      )
#define STR_YES                                 ((LAN_EN == g_LanguageFlag) ? STR_EN_YES                          : STR_CH_YES                           )
                                                                                                                                                  
#define STR_FAIL                                ((LAN_EN == g_LanguageFlag) ? STR_EN_FAIL                         : STR_CH_FAIL                          )
#define STR_FAIL_COUNT                          ((LAN_EN == g_LanguageFlag) ? STR_EN_FAIL_COUNT                   : STR_CH_FAIL_COUNT                    )
#define STR_FAIL_TO_CREATE_OPEN_FILE            ((LAN_EN == g_LanguageFlag) ? STR_EN_FAIL_TO_CREATE_OPEN_FILE     : STR_CH_FAIL_TO_CREATE_OPEN_FILE      )
#define STR_FAIL_TO_CREATE_PTHREAD              ((LAN_EN == g_LanguageFlag) ? STR_EN_FAIL_TO_CREATE_PTHREAD       : STR_CH_FAIL_TO_CREATE_PTHREAD        )
#define STR_FAIL_TO_DELETE_OLD_FILE             ((LAN_EN == g_LanguageFlag) ? STR_EN_FAIL_TO_DELETE_OLD_FILE      : STR_CH_FAIL_TO_DELETE_OLD_FILE       )
#define STR_FAIL_TO_GET_FILE_FOLDER_INFO        ((LAN_EN == g_LanguageFlag) ? STR_EN_FAIL_TO_GET_FILE_FOLDER_INFO : STR_CH_FAIL_TO_GET_FILE_FOLDER_INFO  )
#define STR_FAIL_TO_GET_FILE_INFO               ((LAN_EN == g_LanguageFlag) ? STR_EN_FAIL_TO_GET_FILE_INFO        : STR_CH_FAIL_TO_GET_FILE_INFO         )
#define STR_FAIL_TO_OPEN_FILE                   ((LAN_EN == g_LanguageFlag) ? STR_EN_FAIL_TO_OPEN_FILE            : STR_CH_FAIL_TO_OPEN_FILE             )
#define STR_FAIL_TO_OPEN_LOG_FILE               ((LAN_EN == g_LanguageFlag) ? STR_EN_FAIL_TO_OPEN_LOG_FILE        : STR_CH_FAIL_TO_OPEN_LOG_FILE         )
#define STR_FAIL_TO_READ_FILE                   ((LAN_EN == g_LanguageFlag) ? STR_EN_FAIL_TO_READ_FILE            : STR_CH_FAIL_TO_READ_FILE             )
#define STR_FAIL_TO_SCAN_DIRECTORY              ((LAN_EN == g_LanguageFlag) ? STR_EN_FAIL_TO_SCAN_DIRECTORY       : STR_CH_FAIL_TO_SCAN_DIRECTORY        )
#define STR_FAIL_TO_WRITE_FILE                  ((LAN_EN == g_LanguageFlag) ? STR_EN_FAIL_TO_WRITE_FILE           : STR_CH_FAIL_TO_WRITE_FILE            )
                                                                                                                                                 
#define STR_ERR_FAIL_TO_MALLOC                  ((LAN_EN == g_LanguageFlag) ? STR_EN_ERR_FAIL_TO_MALLOC           : STR_CH_ERR_FAIL_TO_MALLOC            )
#define STR_ERR_INVALID_COLS                    ((LAN_EN == g_LanguageFlag) ? STR_EN_ERR_INVALID_COLS             : STR_CH_ERR_INVALID_COLS              )
#define STR_ERR_INVALID_LINES                   ((LAN_EN == g_LanguageFlag) ? STR_EN_ERR_INVALID_LINES            : STR_CH_ERR_INVALID_LINES             )
#define STR_ERR_PTHREAD_NUM_TOO_BIG             ((LAN_EN == g_LanguageFlag) ? STR_EN_ERR_PTHREAD_NUM_TOO_BIG      : STR_CH_ERR_PTHREAD_NUM_TOO_BIG       )
#define STR_ERR_PTHREAD_NUM_TOO_SMALL           ((LAN_EN == g_LanguageFlag) ? STR_EN_ERR_PTHREAD_NUM_TOO_SMALL    : STR_CH_ERR_PTHREAD_NUM_TOO_SMALL     )
